// Generates AppIcon.icns for Tote.
...
// Bold serif "T" on canvas tan — evokes a canvas tote bag, and pairs
// visually with Wisp (cream + W) as a sibling app while staying
// distinct at icon-grid scale.
func makeIcon(pixelSize: Int) -> Data? {
    ...
    // Canvas tan, full bleed.
    context.setFillColor(red: 0.85, green: 0.72, blue: 0.55, alpha: 1.0)
    ...
    let attrString = NSAttributedString(string: "T", attributes: attrs)
